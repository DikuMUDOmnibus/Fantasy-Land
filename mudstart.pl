...
$exec		=	"/home/loki/fantasyland/area";

# Path where you want the mud logs to be kept.

$logdir		=	"/home/loki/fantasyland/loggywogs";

# Path where we should start the mud from.				#
$startPath	=	"/home/loki/fantasyland/area";
...
#		system ("$exec $port > $logdir/$timet.log 2>&1 &");
                system ("nohup /home/loki/fantasyland/startup 1111 &");
		return;
}
