#define VERSION "GEM (Generously Enhanced MUD) Version 11.16"
...
#define B_BLACK    "\x01B[40m"    /* These are background color codes */
#define B_RED      "\x01B[41m"
#define B_GREEN    "\x01B[42m"
#define B_YELLOW   "\x01B[43m"
#define B_BLUE     "\x01B[44m"
#define B_PURPLE   "\x01B[45m"
#define B_CYAN     "\x01B[46m"
#define B_GREY     "\x01B[47m"
#define INVERSE    "\x01B[7m"

#define CLEAR_SCREEN	"\x01B[2J"
#define CLEAR           "\x01B[0m"		/* Resets Colour        */
#define BLINK           "\x01B[5m"		/* Blink                */
#define C_BLACK		"\x01B[0;30m"	/* Normal Colours       */
...
#define C_D_GREY        "\x01B[1;30m"	/* Light Colors         */
#define C_B_RED         "\x01B[1;31m"
#define C_B_GREEN       "\x01B[1;32m"
#define C_B_YELLOW      "\x01B[1;33m"
#define C_B_BLUE        "\x01B[1;34m"
#define C_B_MAGENTA     "\x01B[1;35m"
#define C_B_CYAN        "\x01B[1;36m"
#define C_B_WHITE       "\x01B[1;37m"
#define R_BLACK		"\x01B[0;30m"	/* Reset Colours       */
#define R_RED           "\x01B[0;31m"
#define R_GREEN         "\x01B[0;32m"
#define R_YELLOW        "\x01B[0;33m"
#define R_BLUE          "\x01B[0;34m"
#define R_MAGENTA       "\x01B[0;35m"
#define R_CYAN          "\x01B[0;36m"
#define R_WHITE         "\x01B[0;37m"
#define R_D_GREY        "\x01B[1;30m"	/* Reset Light         */
#define R_B_RED         "\x01B[1;31m"
#define R_B_GREEN       "\x01B[1;32m"
#define R_B_YELLOW      "\x01B[1;33m"
#define R_B_BLUE        "\x01B[1;34m"
#define R_B_MAGENTA     "\x01B[1;35m"
#define R_B_CYAN        "\x01B[1;36m"
#define R_B_WHITE       "\x01B[1;37m"
...
typedef struct SimpleVariable SIMVAR;
...
#define to_actor(b,c)           send_to_char(b,c)
...
#define MAX_STRING_LENGTH	 32768//9816 /* 4608 */
#define MSL MAX_STRING_LENGTH
#define MAX_INPUT_LENGTH	 4096 //512 /* 256 */
#define PAGELEN			   25
...
#define PULSE_AREA		  (1200 * PULSE_PER_SECOND)
...
// Nimud
#define TO_ACTOR                TO_CHAR
#define TO_SCENE                TO_ROOM
...
#define EX_NOLOCK		(L)
#define EX_SECRET               (M)
#define EX_REVEALED             (N) // temporary
#define EX_EAT_KEY              (O)
#define EX_CONCEALED            (P)
#define EX_JAMMED               (Q) // temporary
#define EX_WINDOW               (R)
#define EX_TRANSPARENT          (S)
#define EX_SLIDING              (T)
#define EX_NOMOVE               (U)
#define EX_JUMPONLY             (V)
...
struct SimpleScript {
 ...
 int concurrent;         // 0=unlimited, 1=singleton, 2... etc, 'concurrent' holds currently running count
 ...
 SIMVAR *script_globals; // Globals available across all scripts of the same type
};// typedef SIMSCRIPT;
...
struct SimpleExecution {
 ...
 int gotos;              // starts at 0 and counts # of goto statements
 ...
 int pace;               // Current pace (number of seconds between script advancement)
 SIMVAR *variables;      // Variables in the current script
};// typedef SIMEXEC;
...
#define PERSO(prop, looker)   ( can_see_obj(looker, prop) ? format_obj_to_char(prop,looker,TRUE): "something" )
...
#define IMPORT_LIST     "import.lst"
#define BACKUP_DIR	"../backup/"
#define ROOM_FILE       "../data/rooms.dat"
...
void display_ascii      args( ( char *name, CHAR_DATA *ch ) ); // displays ascii panels to those who have ASCII Depictions on
...
bool str_infix_nim      args( ( const char *astr, const char *bstr ) );
bool str_infix_2      args( ( const char *astr, const char *bstr ) );
...
bool in_group   args( ( CHAR_DATA *ch, CHAR_DATA *victim ) );
ROOM_INDEX_DATA *random_room args((void));
AREA_DATA*  find_area  args( ( int vnum ) );
 ...
 * Contains all mount/dismount routines. From NiMUD by Locke                 *
 *****************************************************************************/
...
void fread_rooms args((void));
void fwrite_rooms args((void));
...
void	gain_exp	args( ( CHAR_DATA *ch, int gain, bool Bonus ) );
